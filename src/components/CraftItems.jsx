...
const CraftItems = ({ item }) => {
    ...
    // eslint-disable-next-line react/prop-types
    const { _id, item_name, category_name, short_descriptio, price, rating, customization, processing_time, stock_status, image } = item;
    return (
            ...
            <div className="w-full bg-white border shadow-lg rounded-xl p-6 dark:bg-[#1a2641d5]">
                <div className="flex flex-col ">
                    ...
                    <div className="flex-auto justify-evenly">
                        ...
                        <div>
                            <p className="text-sm text-gray-500 dark:text-gray-300 my-2">Type : {stock_status}</p>
                        </div>
