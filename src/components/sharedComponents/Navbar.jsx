    ...
    return (
        <div className="navbar bg-base-100 shadow-lg px-4 fixed z-10">
            <div className="navbar-start">
                ...
                <a className="btn btn-ghost text-xl lg:text-5xl"><span className='text-secondary'>Pastel</span><span className='text-primary'>Cityscapes</span></a>
            </div>
            ...
            <div className="navbar-end space-x-5">
...

                {
                    ...
                    </div> : <Link to="/sign-in"><button className="bg-[#FF497C] hover:bg-[#ab3154] duration-200 text-white font-bold px-4 xl:px-6 py-3 rounded">Login</button></Link>
                }
